# Based on visualize.py in https://github.com/multimodallearning/pytorch-mask-rcnn
"""
Mask R-CNN
...
def apply_mask(image, mask, color, alpha=0.5, threshold=0.5):
...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    for i in range(N):
        ...
        # Mask
        mask = masks[:, :, i]
        masked_image = apply_mask(masked_image, mask, color, threshold=0.5)
    ...
    if save_to:
        ...
        plt.margins(0,0)
        plt.savefig(save_to, dpi=dpi, pad_inches=0)
        plt.close()
